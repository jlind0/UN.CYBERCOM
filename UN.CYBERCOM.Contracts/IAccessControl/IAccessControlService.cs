...
using UN.CYBERCOM.Contracts.IAccessControl.ContractDefinition;

namespace UN.CYBERCOM.Contracts.IAccessControl
{
    public partial class IAccessControlService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, IAccessControlDeployment iAccessControlDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<IAccessControlDeployment>().SendRequestAndWaitForReceiptAsync(iAccessControlDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, IAccessControlDeployment iAccessControlDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<IAccessControlDeployment>().SendRequestAsync(iAccessControlDeployment);
        }

        public static async Task<IAccessControlService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, IAccessControlDeployment iAccessControlDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, iAccessControlDeployment, cancellationTokenSource);
            return new IAccessControlService(web3, receipt.ContractAddress);
        }
        ...
        public IAccessControlService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public IAccessControlService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
