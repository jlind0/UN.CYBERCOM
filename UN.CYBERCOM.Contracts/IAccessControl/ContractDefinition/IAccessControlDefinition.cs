...
namespace UN.CYBERCOM.Contracts.IAccessControl.ContractDefinition
{


    public partial class IAccessControlDeployment : IAccessControlDeploymentBase
    {
        public IAccessControlDeployment() : base(BYTECODE) { }
        public IAccessControlDeployment(string byteCode) : base(byteCode) { }
    }

    public class IAccessControlDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public IAccessControlDeploymentBase() : base(BYTECODE) { }
        public IAccessControlDeploymentBase(string byteCode) : base(byteCode) { }
