...
using UN.CYBERCOM.Contracts.AccessControl.ContractDefinition;

namespace UN.CYBERCOM.Contracts.AccessControl
{
    public partial class AccessControlService
    {
        ...
        public AccessControlService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
