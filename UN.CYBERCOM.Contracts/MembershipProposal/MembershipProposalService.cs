...
using UN.CYBERCOM.Contracts.MembershipProposal.ContractDefinition;

namespace UN.CYBERCOM.Contracts.MembershipProposal
{
    public partial class MembershipProposalService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, MembershipProposalDeployment membershipProposalDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<MembershipProposalDeployment>().SendRequestAndWaitForReceiptAsync(membershipProposalDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, MembershipProposalDeployment membershipProposalDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<MembershipProposalDeployment>().SendRequestAsync(membershipProposalDeployment);
        }

        public static async Task<MembershipProposalService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, MembershipProposalDeployment membershipProposalDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, membershipProposalDeployment, cancellationTokenSource);
            return new MembershipProposalService(web3, receipt.ContractAddress);
        }
        ...
        public MembershipProposalService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public MembershipProposalService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
        ...
        public Task<BigInteger> GroupIdQueryAsync(GroupIdFunction groupIdFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<GroupIdFunction, BigInteger>(groupIdFunction, blockParameter);
        }

        
        public Task<BigInteger> GroupIdQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<GroupIdFunction, BigInteger>(null, blockParameter);
        }
