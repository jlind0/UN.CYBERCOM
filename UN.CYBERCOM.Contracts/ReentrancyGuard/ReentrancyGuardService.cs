...
using UN.CYBERCOM.Contracts.ReentrancyGuard.ContractDefinition;

namespace UN.CYBERCOM.Contracts.ReentrancyGuard
{
    public partial class ReentrancyGuardService
    {
        ...
        public ReentrancyGuardService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
